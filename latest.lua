-- [[ AUTO HIT & UTILITY PANEL - RAYFIELD FIXED ]] --

-- Try different Rayfield loaders
local RayfieldLoaded = false
local Rayfield

-- Attempt 1: Official Rayfield
local success, result = pcall(function()
    Rayfield = loadstring(game:HttpGet('https://raw.githubusercontent.com/shlexware/Rayfield/main/source'))()
end)

if not success or not Rayfield then
    -- Attempt 2: Alternative mirror
    pcall(function()
        Rayfield = loadstring(game:HttpGet('https://raw.githubusercontent.com/SiriusDev/Rayfield/main/source'))()
    end)
end

if not Rayfield then
    -- Attempt 3: Direct load
    pcall(function()
        Rayfield = loadstring(game:HttpGet('https://pastebin.com/raw/rayfield'))()
    end)
end

if not Rayfield then
    -- Fallback: Create simple UI without Rayfield
    print("Rayfield failed to load. Using fallback UI...")
    ...
    Title.Text = "AutoHit Panel (Fallback)"
    ...
    Status.Text = "UI Loaded Successfully!"
    Status.TextColor3 = Color3.fromRGB(0, 255, 0)
    Status.BackgroundTransparency = 1
    Status.Parent = Frame
    
    print("⚠️ Using fallback UI. Features still work!")
    -- Continue with features without UI
else
